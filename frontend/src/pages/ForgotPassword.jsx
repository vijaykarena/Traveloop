    ...
    <div className="flex h-screen bg-background">
      <div className="flex-[0.46] flex flex-col justify-between p-12">
        ...
        <div className="max-w-sm w-full">
          ...
          <h1 className="text-4xl font-semibold tracking-tight mb-2">Forgot password?</h1>
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="text-sm text-muted-foreground text-center">
              Remembered your password? <a className="text-foreground underline cursor-pointer inline-flex items-center gap-1" onClick={() => navigate('login')}><ArrowLeft size={12} /> Back to sign in</a>
            </div>
          </form>
        </div>
