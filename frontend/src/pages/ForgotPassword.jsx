    ...
    <div className="flex flex-col md:flex-row h-screen bg-[var(--bg-page)]">
      ...
      <div className="w-full md:flex-[0.46] flex flex-col justify-between p-6 sm:p-10 md:p-12">
        ...
        <div className="max-w-sm w-full mx-auto md:mx-0">
          ...
          <h1 className="font-display text-3xl sm:text-4xl font-bold tracking-tight text-[var(--text-primary)] mb-2">Forgot password?</h1>
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="text-sm text-[var(--text-tertiary)] text-center">
              ...
              <a className="text-[var(--text-primary)] underline cursor-pointer inline-flex items-center gap-1" onClick={() => navigate('login')}>
