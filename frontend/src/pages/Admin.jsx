          ...
          <Card className="py-0">
            ...
            <CardContent className="p-0">
              ...
              <div className="md:hidden divide-y divide-[var(--border-subtle)]">
                {users.map(r => (
                  <div key={r[0]} className="flex items-center gap-3 p-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="font-medium text-sm truncate">{r[1]}</div>
                      <div className="text-xs text-[var(--text-tertiary)] mt-0.5">
                        Joined {r[2]} · {r[3]} trips · {r[4]}
                      </div>
                    </div>
                    <div className="flex items-center gap-2 shrink-0">
                      <Badge variant={r[5] === 'Active' ? 'success' : 'outline'}>{r[5]}</Badge>
