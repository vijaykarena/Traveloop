  ...
  return (
    <div className="flex flex-col h-screen bg-[var(--bg-page)] text-[var(--text-primary)] font-body overflow-hidden">
      ...
      <div className="grid grid-cols-[1fr_1.4fr] flex-1 overflow-hidden">
        <div className="p-10 border-r border-[var(--border-subtle)] flex flex-col justify-between overflow-auto">
          <div>
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              <div className="h-24 w-24 rounded-full border-2 border-dashed border-[var(--border-default)] grid place-items-center text-[var(--text-tertiary)]">
                <Plus size={28} />
              </div>
              <div className="text-sm text-[var(--text-tertiary)] max-w-[200px]">Drop a square JPG or PNG, ≥ 400×400 px.</div>
            </div>
          </div>
        ...
        <div className="p-10 overflow-auto">
          <h2 className="font-display text-lg font-bold mb-4">Personal details</h2>
